...
@Priority2 @WeeklyAd @TC_WA_CU_001
Scenario: 001 Weekly Ad_Cold View Details Page With Category Filter
	
	Given I am a Cold User
		# Include steps to login app
...
@Priority2 @WeeklyAd @TC_WA_CU_002
Scenario: 002 Weekly Ad_Cold View Details Page With Search Filter
	Given I am a Cold User
...
@Priority2 @WeeklyAd @TC_WA_CU_003
Scenario: 003 Weekly Ad_Cold_View Another Store s Weekly Ad
	Given I am a Cold User
		# Include steps to Open App
		# 1. Click "Continue without registering" button if Login Splash page is displayed 
	Then I navigate to Featured Deals page in Weekly Ad
...
@Priority2 @WeeklyAd @TC_WA_CU_004
Scenario: 004 Weekly Ad_Cold Add Multiple Deals to Shopping List
	Given I am a Cold User
		# Include steps to Open App
		# 1. Click "Continue without registering" button if Login Splash page is displayed 
	Then I navigate to Featured Deals page in Weekly Ad
...
@Priority2 @WeeklyAd @TC_WA_CU_005
Scenario: 005 Weekly Ad_Cold_Select All Deals And Add to List with Category Filter
	Given I am a Cold User
		# Include steps to Open App
		# 1. Click "Continue without registering" button if Login Splash page is displayed 
	Then I navigate to Featured Deals page in Weekly Ad
...
@Priority2 @WeeklyAd @TC_WA_CU_006
Scenario: 006 Weekly Ad_Cold Add to Shopping List from Deal Details Page
	Given I am a Cold User
		# Include steps to Open App
		# 1. Click "Continue without registering" button if Login Splash page is displayed 
	Then I navigate to Featured Deals page in Weekly Ad
...
@Priority1 @WeeklyAd @TC_WA_HU_007
Scenario: 007 Weekly Ad_Hot Search Products With Category Filter And View Details
...
@Priority2 @WeeklyAd @TC_WA_HU_008
Scenario: 008 Weekly Ad_Hot_View Another Stores Weekly Ad Deals
...
@Priority2 @WeeklyAd @TC_WA_HU_009
Scenario: 009 Weekly Ad_Hot_Add to Shopping List Cancel Then Add Multiple Deals
...
@Priority1 @WeeklyAd @TC_WA_HU_010
Scenario: 010 Weekly Ad_Hot_Add All Deals To Shopping List With Category Filter
...
@Priority2 @WeeklyAd @TC_WA_HU_011
Scenario: 011 Weekly Ad_Hot_ Add Item From Item Details Page To A List
...
@Priority1 @WeeklyAd @TC_WA_HU_012
Scenario: 012 Weekly Ad_Hot Search Products Then Add All To List
...
@Priority1 @WeeklyAd @TC_WA_CU_013
Scenario: 013 Weekly Ad_Verify_SelectYourStore_Page
	Given I am a Cold User
		# Include steps to Open App
...
@Priority1 @WeeklyAd @TC_WA_CU_014
Scenario: 014 Weekly Ad_Hot user_Verify_SelectYourStore_Page
	Given I am a Hot User
		# Includes steps 
		# 1. open application and 
		# 2. Login as an user
...
@Priority1 @WeeklyAd @TC_WA_CU_015
Scenario: 015 Weekly Ad_Cold user_Verify_FeaturedDeals_Page
	Given I am a Cold User
		# Include steps to Open App
		# 1. Click "Continue without registering" button if Login Splash page is displayed 
	Then I navigate to Featured Deals page in Weekly Ad
...
@Priority1 @WeeklyAd @TC_WA_HU_016
Scenario: 016 Weekly Ad_Hot user_Verify_FeaturedDeals_Page
...
@Priority1 @WeeklyAd @TC_WA_CU_017
Scenario: 017 Weekly Ad_Cold user_Verify_Item Details_Page
	Given I am a Cold User
		# Include steps to Open App
		# 1. Click "Continue without registering" button if Login Splash page is displayed 
	Then I navigate to Featured Deals page in Weekly Ad
...
@Priority1 @WeeklyAd @TC_WA_HU_018
Scenario: 018 Weekly Ad_Hot user_Verify_Item Details_Page
	Given I am a Hot User
		# Includes steps 
		# 1. open application and 
		# 2. Login as an user
...
@Priority1 @WeeklyAd @TC_WA_CU_019
Scenario: 019 Weekly Ad_Cold User_Add To List
	Given I am a Cold User
		# Include steps to Open App
		# 1. Click "Continue without registering" button if Login Splash page is displayed 
	Then I navigate to Featured Deals page in Weekly Ad
...
@Priority1 @WeeklyAd @TC_WA_HU_020
Scenario: 020 Weekly Ad_Hot user_Add To List
	Given I am a Hot User
		# Includes steps 
		# 1. open application and 
		# 2. Login as an user
